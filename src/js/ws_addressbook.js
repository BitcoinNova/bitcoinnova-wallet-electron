...
var ElectronWalletAddressBook = function (path, name, pass) {
    if (!(this instanceof ElectronWalletAddressBook)) return new ElectronWalletAddressBook(pass, name, path);
    this.path = path;
...
ElectronWalletAddressBook.prototype.setParams = function (path, pass) {
    if (path) this.path = path;
    if (pass) this.pass = pass;
    return true;
};

ElectronWalletAddressBook.prototype.create = function (ignoreExists) {
...
ElectronWalletAddressBook.prototype.initFile = function () {
    return new Promise((resolve, reject) => {
        try {
...
ElectronWalletAddressBook.prototype.load = function () {
    return new Promise((resolve, reject) => {
...
ElectronWalletAddressBook.prototype.save = function (addressBookData) {
    return new Promise((resolve, reject) => {
        let gcm = new GCM(this.pass, this.cipherConfig);
...
module.exports = ElectronWalletAddressBook;
